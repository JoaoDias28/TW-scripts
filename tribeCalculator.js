// This file is the main logic. Host it online.
// It has NO Tampermonkey header and NO outer (function(){...})() wrapper.
...
function numberWithCommas(x) { let p = /(\d+)(\d{3})/; while (p.test(x)) { x = x.toString().replace(p, '$1.$2'); } return x; }
function saveSettings() { tempArray = $("#settings").serializeArray(); minAxeAntiBunk=tempArray[0].value; minLightAntiBunk=tempArray[1].value; minRamAntiBunk=tempArray[2].value; minAxeFullAtk=tempArray[3].value; minLightFullAtk=tempArray[4].value; minRamFullAtk=tempArray[5].value; localStorage.setItem("settingsTribeMembersFullAtk", JSON.stringify(tempArray)); rerunDisplay(); }
...
// =========================================================================
// === EXPOSE FUNCTIONS TO THE LOADER SCRIPT ===
